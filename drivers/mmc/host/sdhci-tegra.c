...
static struct tuning_t2t_coeffs t12x_automotive_tuning_coeffs[] = {
	SET_TUNING_COEFFS("700b0600.sdhci",	1040,	950,	29,	130687,
			29,	130687,	29,	130687),
	SET_TUNING_COEFFS("700b0400.sdhci",	1040,	950,	36,	148855,
			36,	148855, 36,	148855),
	SET_TUNING_COEFFS("700b0000.sdhci",	1040,	950,	37,	149783,
			37,	149783,	37,	149783),
};

static struct tuning_t2t_coeffs t12x_tuning_coeffs[] = {
	SET_TUNING_COEFFS("700b0600.sdhci",	1150,	950,	27,	118295,
		27,	118295,	48,	188148),
	SET_TUNING_COEFFS("700b0400.sdhci",	1150,	950,	29,	124427,
		29, 124427,	 54,	203707),
	SET_TUNING_COEFFS("700b0000.sdhci",	1150,	950,	25,	115933,
		25,	115933,	47,	187224),
};
...
static struct tap_hole_coeffs t12x_automotive_tap_hole_coeffs[] = {
	SET_TAP_HOLE_COEFFS("700b0600.sdhci",	198000,	926,	107053,	926,
		107053,	926,	107053),
	SET_TAP_HOLE_COEFFS("700b0600.sdhci",	189000,	985,	114635,	985,
		114635,	985,	114635),
	SET_TAP_HOLE_COEFFS("700b0600.sdhci",	188000,	991,	115523,	991,
		115523,	991,	115523),
	SET_TAP_HOLE_COEFFS("700b0400.sdhci",	204000,	296,	27274,	296,
		27274,	296,	27274),
	SET_TAP_HOLE_COEFFS("700b0400.sdhci",	94000,	1520,	196114,	1520,
		196114,	1520,	196114),
	SET_TAP_HOLE_COEFFS("700b0000.sdhci",	204000,	578,	67417,	578,
		67417,	578,	67417),
	SET_TAP_HOLE_COEFFS("700b0000.sdhci",	94000,	1785,	219359,	1785,
		219359,	1785,	219359),
};

static struct tap_hole_coeffs t12x_tap_hole_coeffs[] = {
	SET_TAP_HOLE_COEFFS("700b0600.sdhci",	200000,	1037,	106934,	1037,
		106934,	558,	74315),
	SET_TAP_HOLE_COEFFS("700b0600.sdhci",	198000,	1037,	106934,	1037,
		106934,	558,	74315),
	SET_TAP_HOLE_COEFFS("700b0600.sdhci",	136000,	1703,	186307,	1703,
		186307,	890,	130617),
	SET_TAP_HOLE_COEFFS("700b0600.sdhci",	100000,	2452,	275601,	2452,
		275601,	1264,	193957),
	SET_TAP_HOLE_COEFFS("700b0600.sdhci",	81600,	3090,	351666,	3090,
		351666,	1583,	247913),
	SET_TAP_HOLE_COEFFS("700b0400.sdhci",	204000,	468,	36031,	468,
		36031,	253,	21264),
	SET_TAP_HOLE_COEFFS("700b0400.sdhci",	200000,	468,	36031,	468,
		36031,	253,	21264),
	SET_TAP_HOLE_COEFFS("700b0400.sdhci",	136000,	1146,	117841,	1146,
		117841,	589,	78993),
	SET_TAP_HOLE_COEFFS("700b0400.sdhci",	100000,	1879,	206195,	1879,
		206195,	953,	141341),
	SET_TAP_HOLE_COEFFS("700b0400.sdhci",	81600,	2504,	281460,	2504,
		281460,	1262,	194452),
	SET_TAP_HOLE_COEFFS("700b0000.sdhci",	204000,	874,	85243,	874,
		85243,	449,	57321),
	SET_TAP_HOLE_COEFFS("700b0000.sdhci",	136000,	1554,	167210,	1554,
		167210,	793,	115672),
	SET_TAP_HOLE_COEFFS("700b0000.sdhci",	100000,	2290,	255734,	2290,
		255734,	1164,	178691),
	SET_TAP_HOLE_COEFFS("700b0000.sdhci",	81600,	2916,	331143,	2916,
		331143,	1480,	232373),
};
...
static struct tuning_tap_hole_margins t12x_automotive_tap_hole_margins[] = {
	SET_TUNING_TAP_HOLE_MARGIN("700b0600.sdhci", 13),
	SET_TUNING_TAP_HOLE_MARGIN("700b0400.sdhci", 7),
	SET_TUNING_TAP_HOLE_MARGIN("700b0000.sdhci", 10),
};
...
static int sdhci_tegra_freq_gov_init(struct sdhci_host *sdhci)
{
	...
	for (i = 0; i < tegra_host->tuning_freq_count; i++) {
		 ...
		 */
		tegra_host->gov_data->freqs[i] = get_nearest_clock_freq(
				tegra_host->pll_source[0].pll_rate,
				freq);
		freq = get_nearest_clock_freq(
				tegra_host->pll_source[1].pll_rate,
				freq);
...
static int sdhci_tegra_carddetect(struct sdhci_host *sdhost, bool req)
{
	...
	if (tegra_host->card_present == req) {
	...
	if (tegra_host->card_present) {
		...
		/*sdcard power up time max 37msec*/
		...
		/*sdcard power down time min 1ms*/
